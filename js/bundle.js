...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', (e) => {
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_1__.postData)('https://jsonplaceholder.typicode.com/posts', json) // отправляем json на сервер
        .then((data) => {
          console.log(data);
...
/* harmony import */ var _modules_animations__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/animations */ "./js/modules/animations.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_animations__WEBPACK_IMPORTED_MODULE_8__["default"])();
});

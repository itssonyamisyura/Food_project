/******/ (() => {
      ...
      /***/ (
        ...
        function cards() {
          ...
          class MenuCard {
            ...
            render() {
              // создаем структуру, которая помещается в определенный div
        ...
        function forms(formSelector, modalTimerId) {
          ...
          function bindPostData(form) {
            ...
            `;
              ...
              ); // превращаем в массив массивов, после в классический объект, после в json
      ...
      /***/ (
        ...
        function modal(triggerSelector, modalSelector, modalTimerId) {
          ...
          modalTrigger.forEach((btn) => {
            ...
            ); // стрелочная функция чтоб срабатвало после клика
          });
          ...
          function showModalByScroll() {
            ...
            if (
              ...
              //сколько px сверху отлистал польз. по оси y(прокрутка) + видимая часть >= полная прокрутка и контент, который есть
              openModal(modalSelector, modalTimerId);
    ...
    `;
        ...
        `;
          ...
          prev.addEventListener('click', () => {
            if (offset == 0) {
              // когда у нас 1й слайд, мы перемещаеся в конец
      ...
      /***/ (
        ...
        function tabs(
          ...
          function hideTabContent() {
            //скрыть все и показать только тот, который нас интересует(1st)
          ...
          tabsParent.addEventListener('click', (event) => {
            ...
            if (target && target.classList.contains(tabsSelector.slice(1))) {
              tabs.forEach((item, i) => {
                if (target == item) {
                  // если тот элемент, в который мы кликнули, будет совпадать с эл, который мы перебираем, вызываем наши ф-ции
                  hideTabContent();
                  showTabContent(i);
                }
              });
      ...
      /***/ (
        ...
        function timer(id, deadline) {
          function getTimeRemaining(endtime) {
            ...
            if (t <= 0) {
              //если отрицательное время, отображаем 0
              days = 0;
              hours = 0;
              minutes = 0;
              seconds = 0;
  ...
  \*********************************/
      /***/ (
        ...
        const postData = async (url, data) => {
          //передаем url, который передается дальше в fetch, data (данные) которые будут поститься в этой функции
  ...
  \**********************/
    ...
    /* harmony import */ var _modules_calc__WEBPACK_IMPORTED_MODULE_4__ =
      __webpack_require__(/*! ./modules/calc */ './js/modules/calc.js');
    /* harmony import */ var _modules_forms__WEBPACK_IMPORTED_MODULE_5__ =
      __webpack_require__(/*! ./modules/forms */ './js/modules/forms.js');
    /* harmony import */ var _modules_slider__WEBPACK_IMPORTED_MODULE_6__ =
